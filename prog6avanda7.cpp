...
Grading comments in the code below are marked with //-!-
 ...
 A.  5: Appearance:                                                     |
           Selecting exit button will exit the program (1 pt)           |
           Title bar has student’s own netid (1 pt)                     |
           Green Add Points, gray Draw Liness, red Exit                 |
           buttons exist (1 pt)                                         |
           Message label appears at the top (1 pt)                      |
           Label at bottom-right for total line length (0.5 pt)         |
           and below that the current total line length (0.5 pt)        |OK
 B.  5: Black points displayed according to first line of data file     |OK
                                                                        |
 ***The above features must work, otherwise no points given***          |
                                                                        |
 C. 10: Add Point button clicked                                        |-5 add points and lines at the same time
           Each mouse click adds new blue point in that location        |
 D. 15: Draw Line button clicked                                        |OK
           Line starts from mouse click location                        |
           Mouse not released yet: Line is dragged                      |
           Finally mouse released: Line end point is this location      |
 E.  5: Sum of line lengths shown in bottom-right                       |OK
 F.  5: Top message prints based on total length:                       |-5
           If length (so far) less than 105% of optimal: then indicate  |
           If length above: then indicate that instead                  |
 G. 10: Line ends for both beginning and end of line will click to      |-10
        the closest point.                                              |
